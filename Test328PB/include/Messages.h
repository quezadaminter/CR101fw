...
#define PI_SET_SLEEP(reg) (reg = (reg | PI_EVENT_SLEEP_BIT) & (~PI_EVENT_SHUTDOWN_BIT & ~PI_EVENT_REBOOT_BIT))
#define PI_SET_SHUTDOWN(reg) (reg = (reg | PI_EVENT_SHUTDOWN_BIT) & (~PI_EVENT_SLEEP_BIT & ~PI_EVENT_REBOOT_BIT))
#define PI_SET_REBOOT(reg)   (reg = (reg | PI_EVENT_REBOOT_BIT) &   (~PI_EVENT_SLEEP_BIT & ~PI_EVENT_SHUTDOWN_BIT))
